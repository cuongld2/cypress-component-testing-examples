...
<template>
  <div class="bg-white rounded-lg shadow-md p-6">
    ...
    <div v-if="loading" class="text-gray-500">Loading forecast...</div>
    <div v-else-if="error" class="text-red-500">{{ error }}</div>
    <div v-else-if="!forecast || !forecast.forecast.length" class="text-gray-500">No forecast data available</div>
